...
import { Sparkles, Target, Brain, Minus, Plus, Zap, Trophy, ArrowLeft, Repeat, History } from 'lucide-react';
import { WordCard } from '../components/WordCard';
import { StudyHistoryDrawer } from '../components/StudyHistoryDrawer';
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 bg-white/10 hover:bg-white/20 text-white px-3 py-2 rounded-xl transition-colors"
            >
